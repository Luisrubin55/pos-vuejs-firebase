...
<template>
    <div class="border-t border-gray-200 space-y-6 py-6 ">
        ...
        <ul role="list" class="mt-5 divide-y divide-gray-200 border-t border-gray-200 text-sm font-medium text-gray-500">
        ...
        <dl class="space-y-4 border-gray-200 pt-6 text-sm font-medium text-gray-500">
            <Amount>
